...
if (isset($_POST['delete_vouchers'])) {
    deleteVouchersByUptime12(); // Delete vouchers where uptime = '12'
}
?>
    ...
    <div class="col-xs-12">
        ...
        <div class="panel panel-default">
            <div class="panel-body form-group form-group-sm">
                ...
                <!-- Delete Button -->
                <form method="post">
                    <button type="submit" name="delete_vouchers" class="btn btn-danger">Delete All Vouchers with 12 hours uptime</button>
                </form>
            </div>
        </div>
    </div>
